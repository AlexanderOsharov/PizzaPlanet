...
public class PizzaParser {
    ...
    public static ArrayList<Pizza> getPizzas(String organization) throws IOException {
        ArrayList<Pizza> pizzas = new ArrayList<>();
        Document doc = Jsoup.connect(getOrganizationPage(getId(organization))).get();
    ...
    // Мето для формирования ссылки организации по переданному id
